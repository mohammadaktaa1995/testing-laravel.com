...
@section('description', 'Terms of use for Testing Laravel')

@section('article')
<div class="layout-sm">
@markdown
These Testing Laravel terms of use (the “Terms of Use”) apply to all services provided through <https://testing-laravel.com/terms-of-use> by Spatie BVBA, with registered offices at Kruikstraat 22/12, 2018 Antwerp, Belgium and registered at the CBE under number BE 0809.387.596 hereafter referred to as “Testing Laravel” “we”, “us” or “our”.
...
We shall make sure that the latest version of these Terms of Use shall always be available on <https://testing-laravel.com/terms-of-use>.
...
1. “Fee”: the amount to be paid to Spatie to obtain the complete app. This fee shall always be available at <https://testing-laravel.com>;
2. “app”: the Testing Laravel ebook and videos as an educational product listed and described on <https://testing-laravel.com>, including all app material through the ebook and videos;
...
2.1. By accepting these Terms of Use, Spatie grants You access to the complete app after the payment of the Fee. You can always read the content of the app at: <https://testing-laravel.com>.

## 3. Purchase and download of the app

3.1. By purchasing the app, You consent to these Terms of Use. The app cannot be used or downloaded without explicitly consenting to these Terms of Use.
...
3.3. When You purchase the app, You shall be able to download the most recent version of the app.
...
4.8.  We are authorized to send You messages via email regarding the use of our app. If You provide feedback or suggestions regarding our Video app, we may use this information to improve the videos within the app without any obligation to You.

4.9. You shall have an existing and current account in order to purchase and download our Video app. You provide us timely with all necessary and correct information, and ensure that this information remains up-to-date. You shall not provide any false or incorrect information to us about your identity or misrepresent your identity in any other way. We shall only use your personal data for the purposes for which we have this data at our disposal, and in a manner that is in accordance with these Terms of Use and our privacy policy.
...
5.3. The downloaded app can be used unlimited without any restrictions after the purchase thereof. There is no termination on the use of the app after the purchase, but You are only entitled to download the most recent version of the app with a valid email address, as described in Article 3.
